...
impl PickWindow {
    ...
    async fn pick_color(&self) -> ashpd::Result<()> {
        ...
        self_
            .line
            .set_text(&format!("0x{:02X}{:02X}{:02X}", (color.red() * 255.0) as i32, (color.green() *255.0) as i32, (color.blue() *255.0) as i32));
        #[cfg(debug_assertions)]
        println!("({:02X}, {:02X}, {:02X})", (color.red() * 255.0) as i32, (color.green() *255.0) as i32, (color.blue() *255.0) as i32);
        Ok(())
    }
}
